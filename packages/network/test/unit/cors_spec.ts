  ...
  context('.urlOriginsMatch', () => {
    ...
    describe('localhost', () => {
      ...
      it('does not match', function () {
        ...
        this.isFalse('http://localhost:4201', this.url)
      })
    ...
    describe('app.localhost', () => {
      ...
      it('does not match', function () {
        ...
        this.isFalse('http://app.localhost:4201', this.url)
      })
    ...
    describe('local', () => {
      ...
      it('does not match', function () {
        ...
        this.isFalse('http://jennifer.dev.local:4201', this.url)
      })
    ...
    describe('ip address', () => {
      ...
      it('does not match', function () {
        ...
        this.isFalse('http://192.168.5.10:12345', this.url)
      })
